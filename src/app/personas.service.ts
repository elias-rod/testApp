...
export class PersonasService{
  ...
  TraerMaterias(){
    return this.http.get(this.route + "materia/TraerMaterias").toPromise().then(data => data.json());
  }

  TraerIdProfesorSegunIdUsuario(idUsuario){
    let requestOptions = new RequestOptions({
      params : {
        "idUsuario" : idUsuario
      }
    });
    return this.http.get(this.route + "materia/TraerIdProfesorSegunIdUsuario", requestOptions).toPromise().then(data => data.json());
  }

  TraerIdAlumnoSegunIdUsuario(idUsuario){
    let requestOptions = new RequestOptions({
      params : {
        "idUsuario" : idUsuario
      }
    });
    return this.http.get(this.route + "materia/TraerIdAlumnoSegunIdUsuario", requestOptions).toPromise().then(data => data.json());
  }
